...
> **Note:** A canonical copy of this document is maintained within the documentation registry at [`docs/ENTERPRISE_SYSTEM_SPECIFICATION.md`](./docs/ENTERPRISE_SYSTEM_SPECIFICATION.md).
